    ...
    <footer className="footer">
      <div className="container footer-container">
        <div className="footer-box">
          <h3>Noni Talam</h3>
          <p>Pakar pembuat kuih talam tradisional dengan resepi asli warisan turun-temurun.</p>
          <div className="social-links">
            <a href="https://www.tiktok.com/@nonitalam" target="_blank" rel="noopener noreferrer" className="social-icon" title="Follow kami di TikTok">
        ...
        <div className="footer-box">
          ...
          <p>Kunjungi TikTok kami untuk melihat proses pembuatan dan promosi terkini.</p>
          <div style={{ marginTop: '20px' }}>
            ...
            <a href="https://www.tiktok.com/@studiononitalam?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="tiktok-link">
      ...
      <div className="footer-bottom">
        &copy; 2026 Noni Talam. Hak Cipta Terpelihara.
      </div>
    </footer>
  );
};
